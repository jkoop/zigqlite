...
pub const dirs = struct {
    pub const _root = "";
    pub const _58dpxbhsudws = cache ++ "/../..";
};

pub const package_data = struct {
    pub const _58dpxbhsudws = Package{
        .directory = dirs._58dpxbhsudws,
        .pkg = Pkg{ .name = "zigqlite", .path = .{ .path = dirs._58dpxbhsudws ++ "/src/sqlite.zig" }, .dependencies = null },
    };
...
pub const packages = &[_]Package{
    package_data._58dpxbhsudws,
};

pub const pkgs = struct {
    pub const zigqlite = package_data._58dpxbhsudws;
};
